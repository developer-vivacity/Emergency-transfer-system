class AllergiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @allergy.save
        format.html { redirect_to :allergies, notice: 'Allergy was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @allergy.update(allergy_params)
        format.html { redirect_to :allergies, notice: 'Allergy was successfully updated.' }
      else
  ...
  private
    ...
    def allergy_params
      params.fetch(:allergy).permit(:description)
    end
end
