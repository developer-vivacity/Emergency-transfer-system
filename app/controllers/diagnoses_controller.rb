class DiagnosesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @diagnosis.save
        format.html { redirect_to :diagnoses, notice: 'Diagnosis was successfully created.' }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @diagnosis.update(diagnosis_params)
        format.html { redirect_to :diagnoses, notice: 'Diagnosis was successfully updated.' }
      else
  ...
  private
    ...
    def diagnosis_params
      params.fetch(:diagnosis).permit(:coding_system, :code, :description)
    end
end
