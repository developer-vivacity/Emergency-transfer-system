class SymptomsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @symptom.save
        format.html { redirect_to :symptoms, notice: 'Symptom was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @symptom.update(symptom_params)
        format.html { redirect_to :symptoms, notice: 'Symptom was successfully updated.' }
      else
  ...
  private
    ...
    def symptom_params
      params.fetch(:symptom).permit(:description)
    end
end
